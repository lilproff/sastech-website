...
const placeholderPosts: BlogPost[] = [
  {
    ...
    title: "Multi-Agent Orchestration in Logistics",
    excerpt: "A deep-dive into the LangGraph architecture and RAG memory setup behind the AgentDesk deployment.",
    readTime: "8 min read",
    date: "Coming soon",
  ...
  },
  {
    ...
    title: "Next.js 14 + Supabase: The Standard Stack",
    excerpt: "Why we default to this pairing for every enterprise web system, and how we handle multi-tenant isolation.",
    readTime: "5 min read",
    date: "Coming soon",
  ...
  },
  {
    ...
    title: "Building Jarvis OS: A Personal AI Operating System",
    excerpt: "Architecting a C-suite of agents to manage business operations from a single Telegram interface.",
    readTime: "10 min read",
    date: "Coming soon",
    image: "https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3",
    imageAlt: "Writing and technology",
  },
];
